...
if(sessionStorage.getItem('onevs1Horse1') == 'blue') {
    x = 2;
    $('#player2-name').text(sessionStorage.getItem('onevs1Player1BName'));
    $('#player3-name').text(sessionStorage.getItem('onevs1Player2YName'));
} else {
    $('#player1-name').text(sessionStorage.getItem('onevs1Player1RName'));
    $('#player4-name').text(sessionStorage.getItem('onevs1Player2GName'));
}
...
if(sessionStorage.getItem('onevs1Horse1') == 'red') {

    // Code for removing extra players dice and image
    $('#player2-area').css('opacity',0);
    $('#player3-area').css('opacity',0);
    ...
    Player1Name = sessionStorage.getItem('onevs1Player1RName');
    Player4Name = sessionStorage.getItem('onevs1Player2GName');



} else if(sessionStorage.getItem('onevs1Horse1') == 'blue') {

    //Code for removing extra players dice and image
    $('#player1-area').css('opacity',0);
    $('#player4-area').css('opacity',0);
    ...
    Player2Name = sessionStorage.getItem('onevs1Player1BName');
    Player3Name = sessionStorage.getItem('onevs1Player2YName');
...
gameStart = setInterval(function(){
    ...
    if(gameStartNo == -1) {
        ...
        computer1Dice = $(`#player${sessionStorage.getItem('onevs1SCH')}-dice`);
        if(x == sessionStorage.getItem('onevs1SCH') && sessionStorage.getItem('computer') != null) {
...
function transferDiceCode() {
    ...
    if(x == 2 && sessionStorage.getItem('onevs1Horse1') == 'red') {
        x = 4;
    } else if(x == 5 && sessionStorage.getItem('onevs1Horse1') == 'red') {
        x = 1;
    } else if(x == 1  && sessionStorage.getItem('onevs1Horse1') == 'blue') {
        x = 2;
    } else if(x == 4  && sessionStorage.getItem('onevs1Horse1') == 'blue') {
        x = 2;
    }
...
function highlightHorses() {
    ...
    if(x != sessionStorage.getItem('onevs1SCH')) {
...
$('#winners > table tr:nth-child(3)').remove();
$('#winners > table tr:nth-child(3)').remove();
$('#winners > table tr:nth-child(2)').css('margin-bottom','140px')
    ...
    if (lastClick >= (Date.now() - delay)) {
        ...
        if(x == sessionStorage.getItem('onevs1SCH') && sessionStorage.getItem('computer') != null) {
            ...
            setTimeout(()=>{
                ...
                if($(`#player-${sessionStorage.getItem('onevs1SCH')} > table`).find('img').length != 0 
                && randomDice == 6) {
            
                    computerHorsesAtDefault = $(`#player-${sessionStorage.getItem('onevs1SCH')} > table img`);
                ...
                } else if($(`#player-${sessionStorage.getItem('onevs1SCH')} > table`).find('img').length == 0 || randomDice != 6) {
            
                    computerHorsesOnPath = $(`.path td img.${sessionStorage.getItem('onevs1SCHC')}`);
