...
$('#player1-name').text(sessionStorage.getItem('onevs3Player1Name'));
$('#player2-name').text(sessionStorage.getItem('onevs3Player2Name'));
$('#player3-name').text(sessionStorage.getItem('onevs3Player3Name'));
$('#player4-name').text(sessionStorage.getItem('onevs3Player4Name'));
...
gameStart = setInterval(function(){
    ...
    if(gameStartNo == -1) {
        ...
        if(x == sessionStorage.getItem('onevs3SCH1') 
        || x == sessionStorage.getItem('onevs3SCH2') 
        || x == sessionStorage.getItem('onevs3SCH3') 
...
function findWinner(){
    ...
    && $(`td${gameParticipants[2]}`).find('img').length == 4 )){
        ...
        if($(`td${identifyPlayer}57`).find('img').length == 4) {
            $('#player-'+ x +' > table').html('');
            $('#player-'+ x +' > table').css({
                'background-image': 'url("Images/third-winner.png")',
                'background-size': 'contain',
                'background-repeat': 'no-repeat',
                'background-position': 'center'
                }
            ...
            if($(`td.r57`).find('img').length != 4) {
                fourthWinner = $('#player1-name').text();
                xOfFourth = 1;
            } else if($(`td.b57`).find('img').length != 4) {
                fourthWinner = $('#player2-name').text();
                xOfFourth = 2;
            } else if($(`td.y57`).find('img').length != 4) {
                fourthWinner = $('#player3-name').text();
                xOfFourth = 3;
            } else if($(`td.g57`).find('img').length != 4) {
                fourthWinner = $('#player4-name').text();
                xOfFourth = 4;
            }
            ...
            setTimeout(function(){
                ...
                $('#winner4-name').text(fourthWinner);
                ...
                $('#winner4-image').attr('src', `Images/player-image${xOfFourth}.png`)
            },500);
        }
    }
